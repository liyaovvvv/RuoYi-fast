...
/**
 * 【请填写功能名称】对象 jg_jgxw_punish_action
 * 
 * @author ruoyi
 * @date 2019-11-15
 */
public class JgJgxwPunishAction extends BaseEntity
{
    ...
    /** $column.columnComment */
    @Excel(name = "${comment}", readConverterExp = "$column.readConverterExp()")
    private String groupDiscussionDate;

    /** $column.columnComment */
    @Excel(name = "${comment}", readConverterExp = "$column.readConverterExp()")
    private String casesClosedFine;
    ...
    public void setGroupDiscussionDate(String groupDiscussionDate) 
    {
        this.groupDiscussionDate = groupDiscussionDate;
    }

    public String getGroupDiscussionDate() 
    {
        return groupDiscussionDate;
    }
    public void setCasesClosedFine(String casesClosedFine) 
    {
        this.casesClosedFine = casesClosedFine;
    }

    public String getCasesClosedFine() 
    {
    ...
    public void setDeportationDate(String deportationDate) 
    {
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("administrativeReconsider", getAdministrativeReconsider())
            .append("casesClosedExecutionResult", getCasesClosedExecutionResult())
            .append("otherDisposals", getOtherDisposals())
            .append("fine", getFine())
            .append("ifHearingWitnesses", getIfHearingWitnesses())
            .append("cdId", getCdId())
            .append("caseInvolvingPunishment", getCaseInvolvingPunishment())
            .append("lyType", getLyType())
            .append("administrativeCpNa", getAdministrativeCpNa())
            .append("punishActionCode", getPunishActionCode())
            .append("createTime", getCreateTime())
            .append("recordUniqueIdentity", getRecordUniqueIdentity())
            .append("superviseObject", getSuperviseObject())
            .append("discussCollectively", getDiscussCollectively())
            .append("entrustDeptCode", getEntrustDeptCode())
            .append("groupDiscussionConclusion", getGroupDiscussionConclusion())
            .append("implementInstitution", getImplementInstitution())
            .append("legalReviewOpinions", getLegalReviewOpinions())
            .append("administrativePenalties", getAdministrativePenalties())
            .append("setDate", getSetDate())
            .append("casesClosedExecutionWay", getCasesClosedExecutionWay())
            .append("superviseItemCode", getSuperviseItemCode())
            .append("punishProcedure", getPunishProcedure())
            .append("administrativeAction", getAdministrativeAction())
            .append("majorCase", getMajorCase())
            .append("groupDiscussionDate", getGroupDiscussionDate())
            .append("casesClosedFine", getCasesClosedFine())
            .append("punishActionName", getPunishActionName())
            ...
            .append("casesClosedExecution", getCasesClosedExecution())
            ...
            .append("punishAccord", getPunishAccord())
            .append("addressOperating", getAddressOperating())
            .append("punishDocumentCode", getPunishDocumentCode())
            ...
            .append("legalReviewDate", getLegalReviewDate())
            .append("cdBatch", getCdBatch())
            .append("penaltyResult", getPenaltyResult())
            .append("cdTime", getCdTime())
            .append("entrustDept", getEntrustDept())
            .append("legalReview", getLegalReview())
            .append("administrativeCp", getAdministrativeCp())
            .append("deportationDate", getDeportationDate())
